                                ...
                                {item.displayed === true ?
                                    <Button variant="contained" component="span"
                                            className={classes.button} onClick={() => {
                                              this.props.history.push(`/wiadomosci/${item.id}`);
                                            }
                                    }>
                                       <Avatar src={item.avatar}/> {item.username}
                                    </Button> :
...
export default withRouter(withStyles(styles, {withTheme: true})(DrawerNotification));